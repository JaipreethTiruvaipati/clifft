    ...
    passes = [
        ...
        },
        {
            ...
            "detail": (
                ...
                "single-Pauli-type blocks, where the diagonal phase function is the "
                "exact unitary, and accepts a move only if it preserves that "
                "function exactly. Mixed-X/Z blocks are left to folding. Opt-in, "
                "not in the default pipeline. See docs/theory/tcount.md and "
                "tcount_evaluation.md: folding matches PeepholeFusionPass, while "
                "TOHPE goes below it on diagonal blocks with cubic redundancy "
